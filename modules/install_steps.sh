...
install_kernel() {
  if [ "${kernel_image}" = "none" ]; then
    ...
    fetch "http://kernel.ubuntu.com/~kernel-ppa/mainline/v4.8.6/linux-headers-4.8.6-040806_4.8.6-040806.201610310831_all.deb" "${chroot_dir}/root/kernel/linux-headers-all.deb" || die "kernel download failed"
    fetch "http://kernel.ubuntu.com/~kernel-ppa/mainline/v4.8.6/linux-headers-4.8.6-040806-generic_4.8.6-040806.201610310831_amd64.deb" "${chroot_dir}/root/kernel/linux-headers-generic.deb" || die "kernel download failed"
    fetch "http://kernel.ubuntu.com/~kernel-ppa/mainline/v4.8.6/linux-image-4.8.6-040806-generic_4.8.6-040806.201610310831_amd64.deb" "${chroot_dir}/root/kernel/linux-kernel.deb" || die "kernel download failed"
